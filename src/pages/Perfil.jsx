  ...
  return (
    <div className="min-h-screen bg-primary flex flex-col font-secondary">
      ...
      <main className="grow flex flex-col items-center justify-start px-4 py-8 bg-white">
        ...
        {/* TÍTULO */}
        <h1 className="text-4xl md:text-5xl font-bold text-primary text-center mb-8 font-secondary">
          Perfil
        </h1>
            ...
            {['Datos', 'Grupos', 'Historial', 'Amigos'].map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`px-10 cursor-pointer py-3 rounded-t-2xl font-semibold text-lg transition-colors whitespace-nowrap ${
                    isActive
